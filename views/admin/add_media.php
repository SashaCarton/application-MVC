...
<head>
    ...
    <title>Ajouter un média | MÉDIATHÈQUE</title>
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@300;400;700;900&family=Inter:wght@300;400;500;600&display=swap" rel="stylesheet">
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'Inter', sans-serif; background: #000; color: #fff; min-height: 100vh; }
        
        .header {
            position: fixed; top: 0; width: 100%; z-index: 1000; padding: 20px 50px;
            background: rgba(0, 0, 0, 0.95); backdrop-filter: blur(10px);
            border-bottom: 1px solid rgba(255, 255, 255, 0.1);
        }
        
        .nav { display: flex; justify-content: space-between; align-items: center; }
        .logo { font-family: 'Playfair Display', serif; font-size: 28px; font-weight: 900; letter-spacing: 3px; color: #fff; text-decoration: none; }
        
        .main-content { margin-top: 100px; padding: 40px; max-width: 800px; margin-left: auto; margin-right: auto; }
        ...
        .form-label {
            ...
            text-transform: uppercase; letter-spacing: 1px; font-size: 12px; color: #ccc;
        }
        ...
        .btn {
            padding: 15px 30px; border: none; font-weight: 600; text-transform: uppercase;
        ...
        .btn-secondary { background: transparent; color: #ccc; border: 1px solid #ccc; }
        .btn-secondary:hover { background: #ccc; color: #000; }
        
        .specific-fields { display: none; margin-top: 20px; padding: 20px; background: rgba(255, 255, 255, 0.02); border-left: 3px solid #22c55e; }
        
        .message {
            padding: 15px 25px; margin-bottom: 30px; border-left: 4px solid; font-size: 14px; letter-spacing: 0.5px;
        }
        .message.success { background: rgba(34, 197, 94, 0.1); border-color: #22c55e; color: #22c55e; }
        .message.error { background: rgba(239, 68, 68, 0.1); border-color: #ef4444; color: #ef4444; }
    </style>
</head>
<body>
    <header class="header">
    ...
    <main class="main-content">
        <h1 style="font-family: 'Playfair Display', serif; font-size: 2.5rem; text-align: center; margin-bottom: 20px;">Ajouter un média</h1>
        ...
        <div class="form-container">
            <form method="POST" action="/admin/create">
                ...
                <div class="form-group">
                    ...
                    <select id="type" name="type" class="form-select" required onchange="showSpecificFields()">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="titre" name="titre" class="form-input" required 
                           placeholder="Titre du média" value="<?php echo htmlspecialchars($_POST['titre'] ?? ''); ?>">
                </div>

                <div class="form-group">
                    <label for="auteur" class="form-label">Auteur *</label>
                    <input type="text" id="auteur" name="auteur" class="form-input" required 
                           placeholder="Auteur/Réalisateur/Artiste" value="<?php echo htmlspecialchars($_POST['auteur'] ?? ''); ?>">
                </div>

                <div class="form-group">
                    <label for="date_publication" class="form-label">Date de publication *</label>
                    <input type="date" id="date_publication" name="date_publication" class="form-input" required
                           value="<?php echo htmlspecialchars($_POST['date_publication'] ?? ''); ?>">
                </div>

                <!-- Champs spécifiques aux livres -->
                <div id="book-fields" class="specific-fields">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="pageNumber" name="pageNumber" class="form-input" min="1" 
                               placeholder="Ex: 350" value="<?php echo htmlspecialchars($_POST['pageNumber'] ?? ''); ?>">
                    </div>
                </div>

                <!-- Champs spécifiques aux films -->
                <div id="movie-fields" class="specific-fields">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="duration" name="duration" class="form-input" min="1" 
                               placeholder="Ex: 120" value="<?php echo htmlspecialchars($_POST['duration'] ?? ''); ?>">
                    </div>
                    <div class="form-group">
                ...
                <div id="album-fields" class="specific-fields">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="trackNumber" name="trackNumber" class="form-input" min="1" 
                               placeholder="Ex: 12" value="<?php echo htmlspecialchars($_POST['trackNumber'] ?? ''); ?>">
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" id="recordLabel" name="recordLabel" class="form-input" 
                               placeholder="Ex: Sony Music" value="<?php echo htmlspecialchars($_POST['recordLabel'] ?? ''); ?>">
                    </div>
                </div>
    ...
    <script>
        function showSpecificFields() {
            ...
            const allFields = document.querySelectorAll('.specific-fields');
        ...
        // Restaurer l'affichage si on revient avec des données POST
        document.addEventListener('DOMContentLoaded', function() {
            showSpecificFields();
            
            // Validation du formulaire avec modale
            ...
            form.addEventListener('submit', function(e) {
                ...
                if (!type || !titre || !auteur) {
                    e.preventDefault();
                    showAlert('Formulaire incomplet', 'Veuillez remplir tous les champs obligatoires (Type, Titre, Auteur).');
                    return;
                }
